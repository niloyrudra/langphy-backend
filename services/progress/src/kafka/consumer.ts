import { LessonCompletedEventSchema, ProgressUpdatedEventSchema, TOPICS, UserDeletedEventSchema } from "@langphy/shared";
...
export const initConsumer = async () => {
    ...
    await consumer.run({
        eachMessage: async ({topic, message}) => {
            ...
            if( topic === TOPICS.PROGRESS_UPDATED || topic === TOPICS.LESSON_COMPLETED ) {
